...
def main():
    ...
    if not data.empty:
        ...
        # Given that X already has a shape of (samples, sequence, features),
        # we can directly use this for CNN input without additional reshaping
        X_train, X_val, y_train, y_val = train_test_split(X, y, test_size=0.1, random_state=42)

        # Since X is already 3D, pass the shape directly
        ...
        # Evaluate and plot the results as before
        ...
        # Save the model
        model_save_path = os.path.join('C:\\omair\\Projects\\CapStone Project\\Crypto Project results', 'BTC_CNN.h5')
        ...
        plt.suptitle('Convolutional Neural Networks - CNN Model', fontsize=16)
